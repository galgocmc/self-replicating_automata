...
// generation algorithm is not working yet so this will have to work
...
void create_transition_function() {
  ...
  try {
    String filename = "/Users/michaelgalgoczy/Documents/self-replicating_automata/";
    filename += "sdsr_loops/transition_function.table";
...
// simple check in hashmap, should be very fast, but not faster than nested ifs
